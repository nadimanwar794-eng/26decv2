    ...
    <div className="bg-white min-h-screen pb-20 animate-in fade-in slide-in-from-right-8">
       ...
       <div className="p-6 space-y-4">
           ...
           <button 
               ...
               disabled={loading}
               className="w-full p-6 rounded-3xl border-2 border-orange-200 bg-orange-50/50 hover:bg-orange-100 hover:border-orange-300 transition-all group text-left relative overflow-hidden"
           >
               <div className="absolute right-0 top-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                   <Crown size={80} className="text-orange-600" />
               </div>
               <div className="relative z-10">
                   <div className="w-12 h-12 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center mb-4">
                       <PlayCircle size={24} />
                   </div>
                   <h4 className="text-xl font-black text-slate-800 mb-1">Premium Test Series</h4>
                   <p className="text-sm text-slate-500 mb-4">Real exam simulation with timer and detailed analysis.</p>
                   <div className="flex items-center gap-2">
                       <span className="bg-orange-600 text-white px-4 py-2 rounded-lg text-xs font-bold shadow-lg shadow-orange-200">START TEST</span>
                       <span className="text-xs font-bold text-orange-700 bg-white px-2 py-1 rounded border border-orange-200">2 Coins / Test</span>
                   </div>
               </div>
           </button>
